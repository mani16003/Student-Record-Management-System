 ...
 */
public class AdminUserId extends javax.swing.JFrame {
    ...
    private void btnSignUpActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSignUpActionPerformed
        ...
        pd=pwdPass.getText();
        String sql="insert into Admin values('"+unm+"','"+pd+"')";
        try{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUserId.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
